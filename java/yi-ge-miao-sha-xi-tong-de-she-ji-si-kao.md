...
高读和高写的两种处理方式大相径庭。**读请求的优化空间要大一些，而写请求的瓶颈一般都在存储层，优化思路的本质还是基于** [**CAP 理论**](https://en.wikipedia.org/wiki/CAP_theorem)**做平衡**。
