...
[https://mp.weixin.qq.com/s/xB-uiqy4eVsNovEknO9\_5w](https://mp.weixin.qq.com/s/xB-uiqy4eVsNovEknO9_5w)

本文来源：[http://r6f.cn/bZLK](http://r6f.cn/bZLK)
...
![img](https://gitee.com/baicaihenxiao/imageDB/raw/master/uPic/jpg/2020/09/03/640-20200903114546901-114547.jpg)
...
![img](https://gitee.com/baicaihenxiao/imageDB/raw/master/uPic/jpg/2020/09/03/640-20200903114547278-114547.jpg)
...
每次申请过来的内存区域，放到一个链表中 _VirtualSpaceList_，作为其中的一个 Node。看下图。
...
![img](https://gitee.com/baicaihenxiao/imageDB/raw/master/uPic/jpg/2020/09/03/640-20200903114547564-114547.jpg)

链表 VirtualSpaceList 和每个节点 Node 是全局的，而 Node 内部的一个个 MetaChunk 是分配给每个类加载器的。所以一个 Node 通常由分配给多个类加载器的 chunks 组成。

![img](https://gitee.com/baicaihenxiao/imageDB/raw/master/uPic/jpg/2020/09/03/640-20200903114547794-114548.jpg)

当一个类加载器和它加载的所有的类都卸载的时候，它占用的 chunks 就会加入到一个全局的空闲列表中：_ChunkManager_，看下图：

![img](https://gitee.com/baicaihenxiao/imageDB/raw/master/uPic/jpg/2020/09/03/640-20200903114548015-114548.jpg)

这些 chunks 会被复用：如果其他的类加载器加载新的类，它可能就会得到一个空闲列表中的 chunk，而不是去 Node 中申请一个新的 chunk。

![img](https://gitee.com/baicaihenxiao/imageDB/raw/master/uPic/jpg/2020/09/03/640-20200903114548261-114548.jpg)
...
![img](https://gitee.com/baicaihenxiao/imageDB/raw/master/uPic/jpg/2020/09/03/640-20200903114548566-114548.jpg)
...
在 JVM 内部，一个类加载器以一个 _ClassLoaderData_ 结构标识，这个结构引用了一个 _ClassLoaderMetaspace_ 结构，它维护了该加载器使用的所有的 Metachunk。
...
![img](https://gitee.com/baicaihenxiao/imageDB/raw/master/uPic/jpg/2020/09/03/640-20200903114548876-114549.jpg)
...
![img](https://gitee.com/baicaihenxiao/imageDB/raw/master/uPic/jpg/2020/09/03/640-20200903114549169-114549.jpg)
...
同时也要清楚，Metaspace 中的 _Compressed Class Space_ 是永远不会将内存还给操作系统的。我们马上就要介绍这部分内容了。
...
在 64 位平台上，HotSpot 使用了两个压缩优化技术，**Compressed Object Pointers** \(_“CompressedOops”_\) 和 **Compressed Class Pointers**。
...
![img](https://gitee.com/baicaihenxiao/imageDB/raw/master/uPic/jpg/2020/09/03/640-20200903114549428-114549.jpg)

当使用了 compressed class pointers，这个引用是 32 位的值，为了找到真正的 64 位地址，需要加上一个 base 值：

![img](https://gitee.com/baicaihenxiao/imageDB/raw/master/uPic/jpg/2020/09/03/640-20200903114549651-114549.jpg)
...
![img](https://gitee.com/baicaihenxiao/imageDB/raw/master/uPic/jpg/2020/09/03/640-20200903114549951-114550.jpg)
...
![img](https://gitee.com/baicaihenxiao/imageDB/raw/master/uPic/jpg/2020/09/03/640-20200903114550200-114550.jpg)
...
![img](https://gitee.com/baicaihenxiao/imageDB/raw/master/uPic/jpg/2020/09/03/640-20200903114550485-114550.jpg)
...
如果你发现有些地方看得不是很懂，希望你可以先对比一下 原文 - [https://stuefe.de/posts/metaspace/what-is-metaspace/](https://stuefe.de/posts/metaspace/what-is-metaspace/) ，如果是我的翻译问题，烦请告知。
